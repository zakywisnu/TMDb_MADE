...
public class HomeFragmentDirections {
  ...
  @NonNull
  public static ActionHomeToDetailMovie actionHomeToDetailMovie(@NonNull Movie movies) {
    return new ActionHomeToDetailMovie(movies);
  }

  @NonNull
  public static ActionHomeToDetailTvShow actionHomeToDetailTvShow(@NonNull TvShow tvshow) {
    return new ActionHomeToDetailTvShow(tvshow);
  }

  public static class ActionHomeToDetailMovie implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionHomeToDetailMovie(@NonNull Movie movies) {
      if (movies == null) {
    ...
    @NonNull
    public ActionHomeToDetailMovie setMovies(@NonNull Movie movies) {
      if (movies == null) {
        throw new IllegalArgumentException("Argument \"movies\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("movies", movies);
    ...
    public int getActionId() {
      return R.id.actionHomeToDetailMovie;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionHomeToDetailMovie that = (ActionHomeToDetailMovie) object;
    ...
    public String toString() {
      return "ActionHomeToDetailMovie(actionId=" + getActionId() + "){"
          + "movies=" + getMovies()
          + "}";
    }
  }

  public static class ActionHomeToDetailTvShow implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionHomeToDetailTvShow(@NonNull TvShow tvshow) {
      if (tvshow == null) {
    ...
    @NonNull
    public ActionHomeToDetailTvShow setTvshow(@NonNull TvShow tvshow) {
      if (tvshow == null) {
        throw new IllegalArgumentException("Argument \"tvshow\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("tvshow", tvshow);
    ...
    @Override
    public int getActionId() {
      return R.id.actionHomeToDetailTvShow;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionHomeToDetailTvShow that = (ActionHomeToDetailTvShow) object;
    ...
    @Override
    public String toString() {
      return "ActionHomeToDetailTvShow(actionId=" + getActionId() + "){"
          + "tvshow=" + getTvshow()
          + "}";
    }
  }
